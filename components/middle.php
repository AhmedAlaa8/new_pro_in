    ...
    <div class="loadMore">
                    ...
                    <ul class="we-comet">
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="comet-avatar">
                                        <img src="<?= asset("images/resources/comet-3.jpg") ?>" alt="">
                                    </div>
                                    <div class="we-comment">
                                        <div class="coment-head">
        ...
        <div class="central-meta item">
            <div class="user-post">
                <div class="friend-info">
                    <figure>
                        <img src="<?= asset("images/resources/nearly6.jpg") ?>" alt="">
                    </figure>
                    <div class="friend-name">
        ...
        <div class="central-meta item">
            <div class="user-post">
                <div class="friend-info">
                    <figure>
                        <img alt="" src="<?= asset("images/resources/friend-avatar10.jpg") ?>">
                    </figure>
                    <div class="friend-name">
                    ...
                    <div class="post-meta">
                        <div class="linked-image align-left">
                            <a title="" href="#"><img alt="" src="<?= asset("images/resources/page1.jpg") ?>"></a>
                        </div>
                        <div class="detail">
